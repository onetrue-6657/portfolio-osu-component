...
I think my idea of designing a component to deal with graph theory problems will be a better choice than other two, which are too ordinary. Also, designing such a component dealing with graph will help me practice graph theory in competitive programming, which is a great opportunity.

<!-- From the initial idea, I have made some changes to the way vertices behave, from an object vertex to just using tags to represent the vertices, which makes it easier to construct and understand. -->
